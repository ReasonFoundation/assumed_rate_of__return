...
* Data extracted matches more than 99% of at least 1 of the values in either Actuarial Assumed Rate of Investment Return in "Pension Summary and UA", Actuarial Assumed Rate of Investment Return and Discount Rate in "OPEB Summary and UA" report. 
...
d %>% 
  ...
  select(-c(search_terms, context)) %>% unique()
